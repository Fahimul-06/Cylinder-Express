...
export type AdminPermissionKey = 'dashboard' | 'orders' | 'products' | 'offers' | 'hero' | 'locations' | 'users' | 'account_delete' | 'delivery_chat' | 'customer_chat' | 'cylinder_usage' | 'base_points';
...
export const ADMIN_PERMISSION_LABELS: Record<AdminPermissionKey, string> = {
  ...
  base_points: 'Delivery Base Points',
};
